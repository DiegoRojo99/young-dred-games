...
function getMoveWinner(playerOneMoveType, playerOneMoveValue, playerTwoMoveType,
    ...
    if (playerOneMoveType === 'rock') {
        if (playerTwoMoveType === 'scissors' || playerTwoMoveType==='lizard') {
            return 'Player One';
        } else {
            return 'Player Two';
        }
    } else if (playerOneMoveType === 'paper') {
        if (playerTwoMoveType === 'rock' || playerTwoMoveType==='spock') {
            return 'Player One';
        } else {
            return 'Player Two';
        }
    } else if (playerOneMoveType === 'scissors') {
        if (playerTwoMoveType === 'paper' || playerTwoMoveType==='lizard') {
            return 'Player One';
        } else {
            return 'Player Two';
        }
    } else if (playerOneMoveType==='lizard') {
        if (playerTwoMoveType === 'paper' || playerTwoMoveType==='spock') {
            return 'Player One';
        } else {
            return 'Player Two';
        }
    } else {
        if (playerTwoMoveType === 'scissors' || playerTwoMoveType==='rock') {
            return 'Player One';
        } else {
            return 'Player Two';
        }
